package com.example.afiliados.backend.mysql.entity;
...
private static final long serialVersionUID = 1L;
	...
	public String toString() {
		return "ExcelEntity [id=" + id + ", numero_dni_titular=" + numero_dni_titular + ", tipo_rp_o_a=" + tipo_rp_o_a
